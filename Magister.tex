...
Рассматривая центральное сечение вдоль другой оси, можем убедиться в том, что в нелокальной постановке поверхность напряжений имеет более сложную форму. Вариация весоворого параметра $p_1$ влияет на отклонение напряжений на границе, в то время как вариация радиуса нелокального влияния $r$ влияет на размах кромочного эффекта. Важно отметить, что интегральная нагрузка в каждом сечении равна приложенной, что говорит нам о выполнении принципа Сен-Венана. Результаты расчётов представлена на рис. \ref{fig:LongRectStress11VarP} и \ref{fig:LongRectStress11VarR}.
